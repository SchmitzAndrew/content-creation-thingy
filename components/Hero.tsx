                    ...
                    <div className="px-6 pt-6 lg:max-w-2xl lg:pl-8 lg:pr-0">
                        <nav className="flex items-center justify-between lg:justify-start" aria-label="Global">
                            <Link href="/" className="-m-1.5 p-1.5">
                                <span className="sr-only">Content Creation Thingy</span>
                                <Image
                                    className="h-10 w-10 rounded-sm"
                                    src= {logo}
                                    height = {200}
                                    width= {200}
                                    alt="Content Creation Thingy"
                                />
                            </Link>
                            <button
                                type="button"
                            ...
                            <div className="hidden lg:ml-12 lg:flex lg:gap-x-12">
                                {navigation.map((item) => (
                        ...
                        <div className="flex items-center justify-between">
                            <Link href="#" className="-m-1.5 p-1.5">
                                ...
                                <Image
                                    ...
                                    height = {200}
                                    width = {200}
                                    alt="Content Creation Thingy Logo"
                                />
                            </Link>
                            <button
                                type="button"
            ...
            <div className="relative">
                <div className="mx-auto max-w-7xl">
                    <div className="relative z-10 pt-14 lg:w-full lg:max-w-2xl">
                        ...
                        <div className="relative px-6 py-32  lg:px-8  lg:pr-0">
                            <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl">
                                <h1 className="text-4xl font-bold tracking-tight text-slate-900 sm:text-6xl">
                                    Automatically Create Content That Converts
                                </h1>
                                <p className="mt-6 text-lg leading-8 text-slate-700">
                                    Content Creation Thingy uses AI to produce a variety of content that you can build your entire marketing plan around.
                                </p>
